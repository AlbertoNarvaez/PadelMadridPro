...
public class PantallaInicial extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Image imagenFondo = new Image("C:\\Users\\alber\\OneDrive - Universidad Antonio De Nebrija\\Nebrija\\Técnicas de Programación Avanzada\\APP PADEL\\PadelMadridPRO\\imagen\\pantallainicial.png"); // Cambia la ruta a la ubicación de tu imagen
